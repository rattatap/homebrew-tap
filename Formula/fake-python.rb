class FakePython < Formula
  ...
  url "https://raw.githubusercontent.com/rattatap/homebrew-tap/refs/heads/main/Fake_Python_README.md?v=0.7"
  sha256 "67696c00fa3cdaa5cc5bcb954d0631d6fd65163ba76d19f680c76f91e0e1fb19"

  def install
    mkdir bin
    python3 = Pathname(ENV["HOMEBREW_OPT"])/"python@3"
    ln_s python3/"libexec/bin/python", bin/"python"
    ln_s python3/"libexec/bin/python", bin/"python3"
    ln_s python3/"libexec/bin/pip", bin/"pip"
